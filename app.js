...
const deleteMessagesMongoDB = require('./middleware/deleteMessagesMongoDB');
...
app.post('/send-message', async (req, res) => {
    ...
    console.log("brojjjjjjjjj poruka", updated_messages.length, "brojjjjjjjjj poruka");
    let deleted_messages = await deleteMessagesMongoDB(user._id, query_id, updated_messages.length);
